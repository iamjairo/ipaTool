<template>
  <div id="app" :class="{ 'dark': isDark }" class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
    ...
    <!-- Login page -->
    <Login v-else-if="authState === 'unauthenticated'" @login-success="onLoginSuccess" />
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            ...
            <div>
              ...
              <p class="text-xs text-gray-500 dark:text-gray-400">IPA管理工具</p>
            </div>
          </div>
    ...
    <footer class="mt-16 py-8 border-t border-gray-200 dark:border-gray-700">
      <div class="container mx-auto px-4 text-center pb-safe-mobile">
        <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
          <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-2">💡 使用提示</h3>
        ...
        <div class="flex justify-center space-x-6 text-sm">
          ...
          <a href="https://github.com/ruanrrn/ipaTool/issues" class="text-primary-600 hover:text-primary-700 dark:hover:text-primary-500 transition-colors" target="_blank">
            反馈问题
          </a>
          <a href="https://github.com/ruanrrn/ipaTool" class="text-primary-600 hover:text-primary-700 dark:hover:text-primary-500 transition-colors" target="_blank">
            Star 支持
          </a>
        </div>
      </div>
